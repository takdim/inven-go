...
__all__ = ['Barang', 'BarangMasuk', 'BarangKeluar', 'AsetTetap', 'LaporanKerusakan', 'PermintaanBarang', 'User', 'UserLog', 'KategoriBarang', 'MerkBarang', 'KontrakBarang', 'BarangKontrak']
